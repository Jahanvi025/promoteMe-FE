...
export default function WalletTransaction() {
  ...
  const [transactionTableRows, setTransactions] = useState<Transaction[]>([]);
  ...
  }, [transactionData, selectedPage]);

  const header = ["ID", "Creator", "Description", "Price", "Date"];
  ...
  const slicedRows = transactionTableRows.slice(
    page * rowsPerPage,
    ...
    <Box sx={styles.container}>
      <>
        ...
        <TableContainer component={Paper} sx={styles.tableContainer}>
          <Table sx={styles.table} aria-label="wallet transaction table">
            <TableHead>
              <TableRow>
                {header.map((header, index) => (
                  ...
                  >
                    <Box
                      ...
                      alignItems="center"
                      gap={2}
                      justifyContent={header === "Date" ? "center" : "left"}
                    >
                      <Typography
        ...
        <Box sx={{ width: "100%", display: "flex", justifyContent: "center" }}>
          <Paginator
            totalRows={transactionData?.data?.totalTransactions || 0}
